                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=tsm&act=add" class="judul"><i class="material-icons">mail</i> Tambah Data Guru PNS</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="asal_surat" type="text" class="validate" name="asal_surat" required>
                                ...
                                ?>
                            <label for="asal_surat">Nama </label>
                        </div>
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="no_surat" type="text" class="validate" name="no_surat" required>
                                ...
                                ?>
                            <label for="no_surat">Kelengkapan Guru</label>
                        </div>
                        <div class="input-field col s6">
