                ...
                echo '
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col m12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=ggtt" class="judul"><i class="material-icons">image</i> Galeri File Surat Keluar</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    if(isset($_REQUEST['submit'])){
                        ...
                        if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                            header("Location: ./admin.php?page=ggtt");
                            die();
                        } else {

                        $query = mysqli_query($config, "SELECT * FROM tbl_gtt WHERE tgl_catat BETWEEN '$dari_tanggal' AND '$sampai_tanggal' ORDER By id_surat DESC");
                                    ...
                                    if(in_array($eks, $ekstensi) == true){
                                        echo '
                                            <div class="col m3">
                                                ...
                                                <a class="btn light-green darken-1" href="?page=ggtt&act=fsk&id_surat='.$row['id_surat'].'">Tampilkan Ukuran Penuh</a>
                                            </div>';
                                    } else {
                                        ...
                                        if(in_array($eks, $ekstensi2) == true){
                                            echo '
                                                <div class="col m3">
                                                    ...
                                                    <a class="btn light-green darken-1" href="?page=ggtt&act=fsk&id_surat='.$row['id_surat'].'">Lihat Detail File</a>
                                                </div>';
                                        } else {
                                            echo '
                                                <div class="col m3">
                        ...
                        if($pg > 1){
                            $prev = $pg - 1;
                            echo '<li><a href="?page=ggtt&pg=1"><i class="material-icons md-48">first_page</i></a></li>
                                  <li><a href="?page=ggtt&pg='.$prev.'"><i class="material-icons md-48">chevron_left</i></a></li>';
                        } else {
                        ...
                        for($i=1; $i <= $cpg; $i++)
                            if($i != $pg){
                                echo '<li class="waves-effect waves-dark"><a href="?page=ggtt&pg='.$i.'"> '.$i.' </a></li>';
                            } else {
                                echo '<li class="active waves-effect waves-dark"><a href="?page=ggtt&pg='.$i.'"> '.$i.' </a></li>';
                            }

                        //next and last pagging
                        if($pg < $cpg){
                            $next = $pg + 1;
                            echo '<li><a href="?page=ggtt&pg='.$next. '"><i class="material-icons md-48">chevron_right</i></a></li>
                                  <li><a href="?page=ggtt&pg='.$cpg.'"><i class="material-icons md-48">last_page</i></a></li>';
                        } else {
