...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
                                        ...
                                        if ($file != "") {
                                            ...
                                            if (in_array($eks, $ekstensi) == true) {
                                                if ($ukuran < 2500000) {
                                                    ...
                                                    $id_surat = $_REQUEST['id_surat'];
                                                    $query = mysqli_query($config, "SELECT file FROM tbl_gtt WHERE id_surat='$id_surat'");
                                                    ...
                                                    if (!empty($file)) {
                                                        ...
                                                        $query = mysqli_query($config, "UPDATE tbl_gtt SET no_agenda='$no_agenda',tujuan='$tujuan',no_surat='$no_surat',isi='$isi',kode='$nkode',tgl_surat='$tgl_surat',file='$nfile',keterangan='$keterangan',id_user='$id_user' WHERE id_surat='$id_surat'");
                                            ...
                                            $query = mysqli_query($config, "UPDATE tbl_gtt SET no_agenda='$no_agenda',tujuan='$tujuan',no_surat='$no_surat',isi='$isi',kode='$nkode',tgl_surat='$tgl_surat',keterangan='$keterangan',id_user='$id_user' WHERE id_surat='$id_surat'");
        ...
        $query = mysqli_query($config, "SELECT id_surat, no_agenda, tujuan, no_surat, isi, kode, tgl_surat, file, keterangan, id_user FROM tbl_gtt WHERE id_surat='$id_surat'");
        ...
        if ($_SESSION['id_user'] != $id_user and $_SESSION['id_user'] != 1) {
            echo '<script language="javascript">
                        ...
                        window.location.href="./admin.php?page=tgtt";
                      </script>';
        } else { ?>
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">edit</i> Edit Data GTT</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=tgtt&act=edit" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            ?>
                            <label for="no_surat">Status</label>
                        </div>
                        <div class="input-field col s6">
                            ...
                            ?>
                            <label for="tgl_surat">Tanggal Upload</label>
                        </div>
                        <div class="input-field col s6">
                    ...
                    <div class="row">
                        ...
                        <div class="col 6">
                            <a href="?page=tgtt" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                        </div>
                    </div>
