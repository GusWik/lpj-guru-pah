                ...
                if (isset($_REQUEST['page'])) {
                    ...
                    switch ($page) {
                        ...
                        case 'gsk':
                            ...
                            break;
                        case 'tgtt':
                            include "transaksi_gtt.php";
                            break;
                        case 'agtt':
                            include "agenda_gtt.php";
                            break;
                        case 'ggtt':
                            include "galeri_gtt.php";
                            break;
                    }
                } else {
                ?>
                    ...
                    <div class="row">
                        ...
                        //menghitung jumlah gtt
                        $count6 = mysqli_num_rows(mysqli_query($config, "SELECT * FROM tbl_gtt"));
                        ...
                        <div class="col s12 m4">
                            <div class="card cyan">
                                <div class="card-content">
                                    <span class="card-title white-text"><i class="material-icons md-36">mail</i> Jumlah Guru PNS</span>
                                    <?php echo '<h5 class="white-text link">' . $count1 . ' Guru PNS</h5>'; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col s12 m4">
                            <div class="card lime darken-1">
                                <div class="card-content">
                                    <span class="card-title white-text"><i class="material-icons md-36">drafts</i> Jumlah Guru NON PNS</span>
                                    <?php echo '<h5 class="white-text link">' . $count2 . ' Guru NON PNS</h5>'; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col s12 m4">
                            <div class="card deep-orange">
                                <div class="card-content">
                                    <span class="card-title white-text"><i class="material-icons md-36">class</i> Jumlah Klasifikasi Guru</span>
                                    <?php echo '<h5 class="white-text link">' . $count4 . ' Klasifikasi Guru</h5>'; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col s12 m4">
                            <div class="card yellow darken-3">
                                <div class="card-content">
                                    <span class="card-title white-text"><i class="material-icons md-36">class</i> Jumlah Guru GTT</span>
                                    <?php echo '<h5 class="white-text link">' . $count6 . ' Guru GTT</h5>'; ?>
                                </div>
                            </div>
                        </div>
