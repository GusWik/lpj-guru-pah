    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                header("Location: ./admin.php?page=agtt");
                die();
            } else {

                $query = mysqli_query($config, "SELECT * FROM tbl_gtt WHERE tgl_catat BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=agtt" class="judul"><i class="material-icons">print</i> Cetak Agenda GTT<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                        ...
                        <div class="col s10">
                            <div class="disp hidd">';
                                ...
                                if(!empty($institusi)){
                                    ...
                                    echo '<h6 class="up">KEMENTERIAN AGAMA</h6>';
                                }
                                if(!empty($nama)){
                                    echo '<h5 class="up" id="nama">'.$nama.'</h5><br/>';
                                } else {
                                    echo '<h5 class="up" id="nama">KANTOR WILAYAH KEMENTERIAN AGAMA NTB</h5><br/>';
                                }
                                if(!empty($status)){
                                    echo '<h6 class="status">'.$status.'</h6>';
                                } else {
                                    echo '<h6 class="status">LPJ PAH</h6>';
                                }
                                if(!empty($alamat)){
                                    echo '<span id="alamat">'.$alamat.'</span>';
                                } else {
                                    echo '<span id="alamat">Jl. Udayana No.6, Monjok Bar., Kec. Selaparang, Kota Mataram, Nusa Tenggara Bar. 83125</span>';
                                }
                                echo '
                            </div>
                            <div class="separator"></div>

                            <h5 class="hid">AGENDA GURU GTT</h5>';
                            ...
                            <p class="warna agenda">Agenda Guru GTT dari tanggal <strong>'.$d." ".$nm." ".$y.'</strong> sampai dengan tanggal <strong>'.$d2." ".$nm2." ".$y2.'</strong></p>
                        </div>
                        <div class="col s2">
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col 12">
                                        <ul class="left">
                                            <li class="waves-effect waves-light"><a href="?page=agtt" class="judul"><i class="material-icons">print</i> Cetak Agenda Surat Keluar<a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
