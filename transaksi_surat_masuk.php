                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsm" class="judul"><i class="material-icons">mail</i> Guru PNS</a></li>
                        ...
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-4" id="head">
                                <tr>
                                    ...
                                    <th width="30%">Bulan<br/> File</th>
                                    <th width="24%">Nama</th>
                                    <th width="18%">Status<br/>Tgl Upoad</th>
