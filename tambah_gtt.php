...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
                            ...
                            if (!preg_match("/^[a-zA-Z0-9., ]*$/", $nkode)) {
                                ...
                                if (!preg_match("/^[0-9.-]*$/", $tgl_surat)) {
                                    ...
                                    if (!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)) {
                                        ...
                                        $cek = mysqli_query($config, "SELECT * FROM tbl_gtt WHERE no_surat='$no_surat'");
                                            ...
                                            if ($file != "") {
                                                ...
                                                if (in_array($eks, $ekstensi) == true) {
                                                    if ($ukuran < 2500000) {
                                                        ...
                                                        $query = mysqli_query($config, "INSERT INTO tbl_gtt(no_agenda,tujuan,no_surat,isi,kode,tgl_surat,
            ...
            <div class="col s12">
                <nav class="secondary-nav">
                    <div class="nav-wrapper blue-grey darken-1">
                        <ul class="left">
                            <li class="waves-effect waves-light"><a href="?page=tgtt&act=add" class="judul"><i class="material-icons">drafts</i> Tambah Data GTT</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
        ...
        <div class="row jarak-form">
            ...
            <!-- Form START -->
            <form class="col s12" method="POST" action="?page=tgtt&act=add" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s6">
                        <div class="file-field input-field tooltipped" data-position="top" data-tooltip="Jika tidak ada file/ biarkan kosong">
