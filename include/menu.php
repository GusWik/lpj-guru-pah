...
?>
    ...
    <nav class="blue-grey darken-1">
        <div class="nav-wrapper">
            <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">school</i> LPJ PAH</a>
            <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
                    ...
                    <div class="logo-side center blue-grey darken-3">
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            ...
                            if (!empty($data['nama'])) {
                                ...
                                echo '<h5 class="smk-side">Bidang Bimas Hindu</h5>';
                            }
                            if (!empty($data['alamat'])) {
                                echo '<p class="description-side">' . $data['alamat'] . '</p>';
                            } else {
                                echo '<p class="description-side">Bimas Hindu - Kementerian Agama </p>';
                            }
                        }
                        ?>
                    </div>
                ...
                <li class="no-padding">
                    ...
                    if ($_SESSION['admin'] == 1 || $_SESSION['admin'] == 3) { ?>
                        <ul class="collapsible collapsible-accordion">
                            <li>
                                <a class="collapsible-header"><i class="material-icons">repeat</i> Arsip Data</a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="?page=tsm">Guru PNS</a></li>
                                        <li><a href="?page=tsk">Guru NON PNS</a></li>
                                        <li><a href="?page=tgtt">Guru GTT</a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li>
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    <li><a href="?page=asm">Guru PNS</a></li>
                                    <li><a href="?page=ask">Guru NON PNS</a></li>
                                    <li><a href="?page=agtt">GURU GTT</a></li>
                            </div>
                        </li>
                    </ul>
                </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li>
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    <li><a href="?page=gsm">Guru PNS</a></li>
                                    <li><a href="?page=gsk">Guru NON PNS</a></li>
                                    <li><a href="?page=ggtt">Guru GTT</a></li>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul class="center hide-on-med-and-down" id="nv">
                <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">school</i> LPJ PAH</a></li>
                <li>
                    <div class="grs">
                        </>
                </li>
                ...
                <?php
                if ($_SESSION['admin'] == 1 || $_SESSION['admin'] == 3) { ?>
                    <li><a class="dropdown-button" href="#!" data-activates="transaksi">Arsip Data <i class="material-icons md-18">arrow_drop_down</i></a></li>
                ...
                ?>
                <li><a class="dropdown-button" href="#!" data-activates="agenda">Pembukuan Agenda <i class="material-icons md-18">arrow_drop_down</i></a></li>
                ...
                <li><a href="?page=ref">Ceklist Data</a></li>
                <?php
                if ($_SESSION['admin'] == 1) { ?>
